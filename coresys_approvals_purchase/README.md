...
For full documentation — features, installation, configuration, and support — see the
core engine README at [`coresys_approvals/README.md`](../coresys_approvals/README.md).
