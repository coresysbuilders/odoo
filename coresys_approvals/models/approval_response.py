...
# odoo.addons.base.models.ir_model — the import path is identical on Odoo 18.0 and
# 19.0 (core imports it from the same location), verified on the 19.0 runtime.
